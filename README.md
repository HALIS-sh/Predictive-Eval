...
以及一个可用的本地 Qwen 模型，例如：
	•/data/wenhesun/model/Qwen/Qwen2.5-1.5B-Instruct
	•/data/wenhesun/model/Qwen/Qwen3-8B

以及一条已经用 VERL / GRPO 训练好的 RL 轨迹，例如：
...
5.1 Step1：SVD + Rank-1 重建：alpharl_step1_svd_and_rank1.py
